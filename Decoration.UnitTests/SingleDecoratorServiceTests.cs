...
public sealed class SingleDecoratorServiceTests : IDisposable
{
	public ServiceCollection Services { get; }

	public static IEnumerable<object?[]> DefaultCases => TestCases.Create(service => service.Use<DecoratorMock>()).AsTheoryParameters();

	public SingleDecoratorServiceTests()
	{
